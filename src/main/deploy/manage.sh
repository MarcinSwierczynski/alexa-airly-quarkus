...
FUNCTION_NAME=alexa-airly-quarkus
HANDLER=net.swierczynski.alexaairly.AirQualityStreamHandler::handleRequest
RUNTIME=java11
ZIP_FILE=fileb:///Users/marcin/Projects/alexa-airly-quarkus/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///Users/marcin/Projects/alexa-airly-quarkus/target/function.zip
  FUNCTION_NAME=alexa-airly-quarkus-native
